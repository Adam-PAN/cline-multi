...
export const anthropicModels = {
	...
	"claude-mythos-5": {
		...
		cacheWritesPrice: 12.5,
		cacheReadsPrice: 1.0,
		description: "Claude Mythos 5 - most capable model for complex tasks",
	},
	"claude-sonnet-4-6": {
		maxTokens: 64_000,
		contextWindow: 200_000,
...
export const claudeCodeModels = {
	...
	"claude-mythos-5": {
		...anthropicModels["claude-mythos-5"],
		supportsImages: false,
		supportsPromptCache: false,
	},
	"sonnet[1m]": {
...
export const vertexModels = {
	"gemini-3.7-flash": {
		...
		description: "Latest Gemini 3.7 Flash - fast and efficient",
	},
	"gemini-3.6-flash": {
		maxTokens: 65536,
		contextWindow: 1_048_576,
	...
	"gemini-3.1-pro": {
		...
		description: "Gemini 3.1 Pro - GA release, latest pro model",
	},
	"gemini-3.1-flash-lite": {
		...
		description: "Gemini 3.1 Flash Lite - GA release, cost-effective",
	},
...
export const openAiNativeModels = {
	"gpt-5.6-sol": {
		...
		description: "GPT-5.6 Sol - Latest frontier agentic coding model",
	},
	"gpt-5.6-terra": {
		maxTokens: 16_384,
		contextWindow: 256_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.6 Terra - Balanced agentic coding model",
	},
	"gpt-5.6-luna": {
		maxTokens: 16_384,
		contextWindow: 128_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.6 Luna - Fast and affordable agentic model",
	},
	"gpt-5.6-sol-pro": {
		maxTokens: 16_384,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.6 Sol Pro - pro tier agentic coding model",
	},
	"gpt-5.6-terra-pro": {
		maxTokens: 16_384,
		contextWindow: 1_050_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.6 Terra Pro - pro tier balanced model",
	},
	"gpt-5.6-luna-pro": {
		maxTokens: 16_384,
		contextWindow: 1_050_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.6 Luna Pro - pro tier fast and affordable",
	},
	"gpt-5.4-pro": {
		maxTokens: 16_384,
		contextWindow: 1_050_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.4 Pro - pro tier for complex tasks",
	},
	"gpt-5.5-pro": {
		maxTokens: 16_384,
		contextWindow: 1_050_000,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.5 Pro - Pro tier for complex tasks (Responses-only)",
	},
	"gpt-5.2-pro": {
		maxTokens: 16_384,
		...
		supportsReasoning: true,
		supportsReasoningEffort: true,
		description: "GPT-5.2 Pro - Pro tier for complex tasks",
	},
	"gpt-5.1-mini": {
		maxTokens: 16_384,
		contextWindow: 272_000,
...
export const deepSeekModels = {
	...
	"deepseek-v4-flash-vision-exp": {
		...
		cacheWritesPrice: 0.14,
		cacheReadsPrice: 0.0028,
		description: "DeepSeek V4 Flash with vision/image support",
	},
	"deepseek-v4-flash-0731": {
		...
		cacheReadsPrice: 0.0014,
		description: "DeepSeek V4 Flash 0731 - 1.3M context, latest fast model",
	},
	"deepseek-v3.2": {
		maxTokens: 16_384,
...
export const internationalQwenModels = {
	"qwen3.8-max": {
		...
		outputPrice: 10,
		supportsReasoning: true,
		thinkingConfig: { maxBudget: 38_912, outputPrice: 20 },
		description: "Qwen3.8 Max - latest flagship reasoning model",
	},
	"qwen3.8-flash": {
		maxTokens: 65_536,
		contextWindow: 1_000_000,
		...
		outputPrice: 2,
		supportsReasoning: true,
		thinkingConfig: { maxBudget: 38_912, outputPrice: 5 },
		description: "Qwen3.8 Flash - 1M context, fast + affordable",
	},
	"qwen3.7-max": {
		maxTokens: 65_536,
		contextWindow: 1_000_000,
		...
		outputPrice: 7,
		supportsReasoning: true,
		thinkingConfig: { maxBudget: 38_912, outputPrice: 15 },
	},
	"qwen3.7-plus": {
		maxTokens: 65_536,
		contextWindow: 1_000_000,
	...
	"qwen3-coder-flash": {
		...
		inputPrice: 0.5,
		outputPrice: 2,
		description: "Qwen3 Coder Flash - fast coding model, 1M context",
	},
	"qwen3-coder-next": {
		maxTokens: 65_536,
		contextWindow: 262_144,
		...
		inputPrice: 1.5,
		outputPrice: 7.5,
		description: "Qwen3 Coder Next - next-gen open coder (480B MoE)",
	},
	"qwen3-coder-plus": {
		maxTokens: 65_536,
		contextWindow: 1_000_000,
...
export const doubaoModels = {
	"seed-2-1-turbo": {
		...
		inputPrice: 0.5,
		outputPrice: 2.0,
		description: "Seed 2.1 Turbo - ByteDance latest fast model",
	},
	"seed-2.0-code": {
		maxTokens: 32_768,
		contextWindow: 262_144,
		...
		inputPrice: 0.5,
		outputPrice: 2.0,
		description: "Seed 2.0 Code - coding specialist",
	},
	"seed-2.0-lite": {
		maxTokens: 32_768,
		contextWindow: 262_144,
...
export const xaiModels = {
	"grok-4.20": {
		...
		outputPrice: 5.0,
		cacheReadsPrice: 0.125,
		description: "Grok 4.20 - latest flagship, 2M context",
	},
	"grok-4.20-multi-agent": {
		...
		outputPrice: 5.0,
		cacheReadsPrice: 0.125,
		description: "Grok 4.20 Multi-Agent - optimized for multi-agent workflows",
	},
	"grok-4.6": {
		maxTokens: 131_072,
...
export const moonshotModels = {
	"kimi-k3": {
		...
		cacheReadsPrice: 0.2,
		temperature: 1.0,
		description: "Kimi K3 - Moonshot AI latest flagship model, 1M context",
	},
	"kimi-k2.7-code": {
		maxTokens: 32_000,
		contextWindow: 262_144,
		...
		cacheReadsPrice: 0.1,
		temperature: 0.6,
		description: "Kimi K2.7 Code - coding specialist model",
	},
	"kimi-k2.6": {
		maxTokens: 32_000,
		contextWindow: 262_144,
...
export const internationalZAiModels = {
	"glm-5.3-flash": {
		...
		inputPrice: 0.3,
		outputPrice: 1.2,
		description: "GLM-5.3 Flash - latest fast model, 1.3M context",
	},
	"glm-5.3": {
		maxTokens: 128_000,
		contextWindow: 1_048_576,
		...
		inputPrice: 0.8,
		outputPrice: 3.0,
		description: "GLM-5.3 - latest generation, 1M context",
	},
	"glm-5.2": {
		maxTokens: 128_000,
		contextWindow: 1_048_576,
	...
	"glm-5v-turbo": {
		...
		inputPrice: 0.3,
		outputPrice: 1.2,
		description: "GLM-5V Turbo - vision + text model",
	},
	"glm-4.7-flash": {
		maxTokens: 128_000,
		contextWindow: 202_752,
...
export const minimaxModels = {
	"MiniMax-M3": {
		...
		description: "MiniMax M3 - latest flagship, 1M context",
	},
	"MiniMax-M1": {
		maxTokens: 128_000,
		contextWindow: 1_000_000,
