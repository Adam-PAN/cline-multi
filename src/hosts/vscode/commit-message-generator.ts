...
async function performCommitMsgGeneration(controller: Controller, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "cline-multi.isGeneratingCommit", true)
		...
		vscode.commands.executeCommand("setContext", "cline-multi.isGeneratingCommit", false)
	}
}
