...
export class VscodeCommentReviewController extends CommentReviewController implements vscode.Disposable {
	...
	constructor() {
		...
		this.disposables.push(
			vscode.commands.registerCommand("cline-multi.reviewComment.reply", async (reply: vscode.CommentReply) => {
		...
		this.disposables.push(
			vscode.commands.registerCommand("cline-multi.reviewComment.addToChat", async (thread: vscode.CommentThread) => {
